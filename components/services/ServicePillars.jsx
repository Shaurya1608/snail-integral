            ...
            <div className="grid grid-cols-1 gap-12">
              {pillar.services.map((service, sIdx) => (
                <AnimatedText key={sIdx} delay={0.15 * sIdx}>
                  <div id={service.id} className="scroll-mt-24 bg-white border border-gray-150/50 rounded-[2rem] p-8 md:p-12 shadow-[0_4px_30px_rgba(0,0,0,0.015)] hover:shadow-[0_15px_40px_rgba(106,154,56,0.06)] hover:-translate-y-1 transition-all duration-300">
