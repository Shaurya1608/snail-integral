      ...
      <div className="max-w-7xl mx-auto flex flex-col items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 w-full mb-10 max-w-6xl">
          {industries.map((industry, index) => (
            <div 
              key={index} 
              className="bg-white border border-gray-100 rounded-xl p-6 hover:-translate-y-1 hover:shadow-xl transition-all duration-300 flex flex-col gap-2 group relative overflow-hidden"
            >
              ...
              <p className="text-gray-500 text-sm leading-relaxed pl-3 mt-1">
